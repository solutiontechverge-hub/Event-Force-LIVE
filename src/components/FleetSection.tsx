...
const FleetSection = () => {
  ...
  return (
    <Box
      sx={{ py: 10, px: { lg: 12, md: 6, xs: 2 }, backgroundColor: "grey.50" }}
    >
      <Fade in={visible} timeout={700}>
        <Box>
          ...
          <Box sx={{ position: "relative" }}>
            ...
            <Box sx={{ overflow: "hidden", pb: 4 }}>
              <Box
                ...
                sx={{
                  ...
                  transform: isMobile
                    ? `translateX(${language === "ar" ? currentIndex * 100 : -currentIndex * 100}%)`
                    : `translateX(${language === "ar" ? currentIndex * 25 : -currentIndex * 25}%)`, // 25% for 4 cards on lg
                }}
              >
                {fleet.map((car, index) => (
                  <Box
                  ...
                  >
                    ...
                    >
                      <CardMedia
                        ...
                        onMouseEnter={() =>
                          !isMobile && setHoveredImageIndex(index)
                        }
            ...
            >
              {Array.from({ length: Math.max(1, fleet.length - 3) }).map(
                (_, index) => (
                  <Box
                    key={index}
                    ...
                    sx={{
                      ...
                      borderRadius: "50%",
                      backgroundColor:
                        index === currentIndex ? "#52A4C1" : "grey.300",
                      cursor: "pointer",
                      transition: "all 0.3s",
                      "&:hover": {
                        backgroundColor:
                          index === currentIndex ? "#4A8FA8" : "grey.400",
                      },
                    }}
                  />
                ),
